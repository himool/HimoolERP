  ...
  <div>
    ...
    >
        ...
        <a-col :span="8">
          <a-form-model-item :wrapper-col="{ span: 24 }">
            ...
            >
              ...
              <a-radio-button value="-6" style="width: 25%"
                >近7天</a-radio-button
              >
              <a-radio-button value="-29" style="width: 25%"
                >近30天</a-radio-button
              >
            </a-radio-group>
          </a-form-model-item>
      ...
      <a-descriptions style="text-align: center">
        <a-descriptions-item label="采购次数"
          ><span class="total">{{ totalTimes }}</span></a-descriptions-item
        >
        <a-descriptions-item label="采购总数"
          ><span class="total">{{ totalQuantity }}</span></a-descriptions-item
        >
        <a-descriptions-item label="采购金额(元)"
          ><span class="total">{{ totalAmount }}</span></a-descriptions-item
        >
      </a-descriptions>
