<template>
  <div>
    <a-modal v-model="visible" title="选择采购关联单" width="640px" :footer="null" :maskClosable="false" @cancel="cancel">
      <div>
        <a-input-search v-model="searchForm.search" placeholder="单号/仓库/供应商" @search="search" />
      </div>
