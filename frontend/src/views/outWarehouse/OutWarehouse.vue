<template>
  <div>
    <a-row gutter="12">
        ...
        <a-card>
          <a-row gutter="8" style="margin-bottom: 8px;">
            <a-col :span="24" :xl="12" style="margin-bottom: 8px;">
              <a-select v-model="searchForm.warehouse" placeholder="公司" style="width: 100%;" allowClear @change="search">
            ...
            <a-col :span="24" :xl="12" style="margin-bottom: 8px;">
              <a-select v-model="orderType" placeholder="单据类型" style="width: 100%;" @change="search">
                ...
                <a-select-option value="purchaseReturn">采购退货单</a-select-option>
              </a-select>
            </a-col>
      ...
      <a-col :span="24" :lg="16">
        <div v-if="form.id">
          <sales-form v-if="orderType == 'sales'" :form="form" @confirm="confirm" />
          <purchase-form v-else :form="form" @confirm="confirm" />
        </div>
