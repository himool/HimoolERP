<template>
  <div>
    ...
    <a-row gutter="8" style="margin-top: 8px;">
      <a-col :span="6">
        <a-card hoverable>
          <a-statistic title="应付金额(元)" :value="statistics.total_amount" :loading="cardLoading" />
        </a-card>
      </a-col>
      <a-col :span="6">
        <a-card hoverable>
          <a-statistic title="已付金额(元)" :value="statistics.amount" :loading="cardLoading" />
        </a-card>
      </a-col>
      <a-col :span="6">
        <a-card hoverable>
          <a-statistic title="待付金额(元)" :value="NP.minus(statistics.total_amount, statistics.amount)"
            :loading="cardLoading" />
        </a-card>
      </a-col>
      <a-col :span="6">
