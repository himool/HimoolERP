    ...
    methods: {
      ...
      list() {
        ...
        goodsList({ search: this.searchText, page: this.currentPage, page_size: this.perPage })
          .then(resp => {
            ...
            that.goodsItems = resp.data.results;
          })
          ...
          if (valid) {
            salesTaskCreate(this.form)
              .then((resp) => {
                ...
                that.formModalVisible = false;
                that.$emit('create', resp.data);
      ...
      resetForm() {
        this.form = {
          ...
          warehouse: null,
          quantity: 1,
          start_date: moment().startOf('day').format(this.dateTimeFormat),
          end_date: moment().startOf('day').format(this.dateTimeFormat),
        };
      },
    },
    watch: {
