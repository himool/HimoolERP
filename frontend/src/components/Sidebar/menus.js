export default [
  ...
  },
  {
    key: '7', name: '基础数据', icon: 'table', submenus: [
      ...
      { key: '/incomeExpenditureItems', name: '收支项目' },
    ]
  },
  {
  ...
  },
  {
    key: '5', name: '库存管理', icon: 'database', submenus: [
      ...
      { key: '/requisition', name: '调拨' },
      { key: '/flow', name: '库存流水' },
      { key: '/counting_list', name: '盘点' },
    ]
  },
  {
    key: '6', name: '财务管理', icon: 'dollar', submenus: [
      { key: '/sales_statistics', name: '销售收款' },
      { key: '/purchase_statistics', name: '采购付款' },
      { key: '/incomeExpenditure', name: '日常收支' },
      { key: '/sales_order_profit', name: '成本管理' },
    ]
  },
  {
    key: '8', name: '系统管理', icon: 'team', submenus: [
      { key: '/role', name: '角色权限' },
      { key: '/subuser', name: '员工账号' },
